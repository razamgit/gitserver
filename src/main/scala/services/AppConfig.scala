...
object AppConfig {
  def load: AppConfig = {
    ...
    val db = PgConfig(
      cfg.getString("db.serverName"), cfg.getInt("db.portNumber"),
      cfg.getString("db.databaseName"), cfg.getString("db.user"),
      cfg.getString("db.password"), cfg.getInt("db.maxPoolSize"))
